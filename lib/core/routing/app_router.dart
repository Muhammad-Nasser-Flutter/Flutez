...
import 'package:flutez/features/Downloads/Presentation/downloads_screen.dart';
...
class AppRouter {
  Route generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case Routes.playingNowOfflineScreen:
        return PageTransition(
          child: const OfflinePlayingNowScreen(),
          type: PageTransitionType.fade,
          alignment: Alignment.center,
          settings: settings,
        );
      ...
      case Routes.searchScreen:
        return PageTransition(
          child: BlocProvider(create: (BuildContext context) => SearchCubit(), child: SearchScreen()),
          type: PageTransitionType.fade,
          alignment: Alignment.center,
          settings: settings,
        );
